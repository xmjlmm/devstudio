...
class BillHomePage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/BillHomePage.ets(113:5)", "entry");
            Column.width('100%');
            Column.height('100%');
            Column.padding({ left: 16, right: 16 });
            Column.backgroundColor({ "id": 16777218, "type": 10001, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
            Column.expandSafeArea([SafeAreaType.SYSTEM], [SafeAreaEdge.TOP, SafeAreaEdge.BOTTOM]);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create({ alignContent: Alignment.TopStart });
            Stack.debugLine("entry/src/main/ets/pages/BillHomePage.ets(114:7)", "entry");
            Stack.width('100%');
            Stack.height('100%');
        }, Stack);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Flex.create({ direction: FlexDirection.Column });
            Flex.debugLine("entry/src/main/ets/pages/BillHomePage.ets(115:9)", "entry");
        }, Flex);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Search.debugLine("entry/src/main/ets/pages/BillHomePage.ets(118:11)", "entry");
            Search.width('100%');
            Search.height(40);
            Search.flexShrink(0);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            List.debugLine("entry/src/main/ets/pages/BillHomePage.ets(170:11)", "entry");
            List.width('100%');
            List.flexGrow(1);
            ...
            const forEachItemGenFunction = (_item, index: number) => {
                const item = _item;
                {
                    ...
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ...
                        ListItem.debugLine("entry/src/main/ets/pages/BillHomePage.ets(172:15)", "entry");
                    };
                    const deepRenderFunction = (elmtId, isInitialRender) => {
                        itemCreation(elmtId, isInitialRender);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Column.create();
                            Column.debugLine("entry/src/main/ets/pages/BillHomePage.ets(173:17)", "entry");
                        }, Column);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Row.create();
                            Row.debugLine("entry/src/main/ets/pages/BillHomePage.ets(174:19)", "entry");
                            Row.width('100%');
                            Row.padding({ top: 4, bottom: 4 });
                        }, Row);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Row.create();
                            Row.debugLine("entry/src/main/ets/pages/BillHomePage.ets(175:21)", "entry");
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            SymbolGlyph.debugLine("entry/src/main/ets/pages/BillHomePage.ets(176:23)", "entry");
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("entry/src/main/ets/pages/BillHomePage.ets(189:21)", "entry");
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Blank.create();
                            Blank.debugLine("entry/src/main/ets/pages/BillHomePage.ets(194:21)", "entry");
                            Blank.layoutWeight(1);
                        }, Blank);
                        Blank.pop();
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Text.create(item.accountType === 0 ? '-' + item.amount.toString() : '+' + item.amount.toString());
                            Text.debugLine("entry/src/main/ets/pages/BillHomePage.ets(197:21)", "entry");
                            Text.fontSize(16);
                            Text.fontColor(item.accountType === 0 ? { "id": 16777221, "type": 10001, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" } : { "id": 16777220, "type": 10001, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
                        }, Text);
                        Text.pop();
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            If.create();
                            if (this.isEdit) {
                                this.ifElseBranchUpdateFunction(0, () => {
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Row.create();
                                        Row.debugLine("entry/src/main/ets/pages/BillHomePage.ets(202:23)", "entry");
                                        Row.margin({ left: 10 });
                                    }, Row);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Toggle.create({ type: ToggleType.Checkbox });
                                        Toggle.debugLine("entry/src/main/ets/pages/BillHomePage.ets(203:25)", "entry");
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            if (index !== this.accounts.length - 1) {
                                this.ifElseBranchUpdateFunction(0, () => {
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Divider.create();
                                        Divider.debugLine("entry/src/main/ets/pages/BillHomePage.ets(220:21)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (!this.isEdit) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/pages/BillHomePage.ets(253:11)", "entry");
                        Row.alignItems(VerticalAlign.Center);
                        Row.justifyContent(FlexAlign.Center);
                        Row.width(48);
                        Row.height(48);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        SymbolGlyph.debugLine("entry/src/main/ets/pages/BillHomePage.ets(254:13)", "entry");
                        SymbolGlyph.fontSize(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.isEdit) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("entry/src/main/ets/pages/BillHomePage.ets(280:11)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        SymbolGlyph.debugLine("entry/src/main/ets/pages/BillHomePage.ets(281:13)", "entry");
                        SymbolGlyph.fontSize(20);
                        SymbolGlyph.fontColor([Color.Black]);
                        SymbolGlyph.fontWeight(400);
                    }, SymbolGlyph);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create({ "id": 16777231, "type": 10003, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
                        Text.debugLine("entry/src/main/ets/pages/BillHomePage.ets(285:13)", "entry");
                        Text.fontSize(12);
                        Text.fontColor('rgba(0, 0, 0, 0.9)');
                        Text.lineHeight(16);
                        Text.fontWeight(400);
    ...
    NavigationTitle(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("entry/src/main/ets/pages/BillHomePage.ets(311:5)", "entry");
            Flex.height(56);
            Flex.flexShrink(0);
        }, Flex);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.isEdit) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/pages/BillHomePage.ets(313:9)", "entry");
                        Row.alignItems(VerticalAlign.Center);
                        Row.justifyContent(FlexAlign.Center);
                        Row.width(40);
                        Row.height(40);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        SymbolGlyph.debugLine("entry/src/main/ets/pages/BillHomePage.ets(314:11)", "entry");
        ...
        If.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.isEdit ? { "id": 16777233, "type": 10003, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" } : { "id": 16777228, "type": 10003, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/pages/BillHomePage.ets(332:7)", "entry");
            Text.fontSize(20);
            Text.fontWeight(700);
            Text.lineHeight(27);
            Text.fontColor('rgba(0, 0, 0, 0.9)');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/BillHomePage.ets(339:7)", "entry");
            Row.alignItems(VerticalAlign.Center);
            Row.justifyContent(FlexAlign.Center);
            Row.width(40);
            Row.height(40);
            ...
            Row.onClick(() => {
                if (this.accounts.length === 0) {
                    try {
                        this.getUIContext().getPromptAction().showToast({ message: { "id": 16777227, "type": 10003, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" } });
                    }
                    catch (error) {
            ...
            if (this.isEdit) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        SymbolGlyph.debugLine("entry/src/main/ets/pages/BillHomePage.ets(341:11)", "entry");
                        SymbolGlyph.fontColor(['rgba(0,0,0,0.9)']);
                        SymbolGlyph.fontSize(24);
                    }, SymbolGlyph);
                });
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        SymbolGlyph.debugLine("entry/src/main/ets/pages/BillHomePage.ets(345:11)", "entry");
                        SymbolGlyph.fontSize(24);
                        SymbolGlyph.fontWeight(400);
                    }, SymbolGlyph);
                });
